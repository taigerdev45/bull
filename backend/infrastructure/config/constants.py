...
REFERENTIEL_INPTIC = [
    SemestreConfig(
        ...
        ues=[
            UEConfig(
                code="UE5-1", libelle="Enseignement Général", credits=11,
                matieres=[
            ...
            UEConfig(
                code="UE5-2", libelle="Réseaux d'Entreprise", credits=19,
                matieres=[
    ...
    SemestreConfig(
        ...
        ues=[
            UEConfig(
                code="UE6-1", libelle="Sciences de Base", credits=20,
                matieres=[
            ...
            UEConfig(
                code="UE6-2", libelle="Télécommunications", credits=10,
                matieres=[
